  ...
  const loadProviders = async () => {
    try {
      ...
      setProviders([
        ...
        {id: "gemini", name: "Google Gemini", description: "Gemini Pro", requires_api_key: true, available_models: ["gemini-flash-latest", "gemini-pro-latest"], is_local: false, has_system_key: false },
      ]);
    }
  };
